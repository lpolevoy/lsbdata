...
const stTemps = {"temperatures":{"2017-12-31":13860.1363,"2018-01-01":13412.44,"2018-01-02":14740.7563,"2018-01-03":15134.6513,"2018-01-04":15155.2263,"2018-01-05":16937.1738,"2018-01-06":17135.8363,"2018-01-07":16178.495,"2018-01-08":14970.3575,"2018-01-09":14439.4738,"2018-01-10":14890.7225,
...
function parseData(data) {
    // var arr = []; // new empty array
    for (var i in data.temperatures) { // for every temperatures in parsed data
        arr.push({
            date: new Date(i), //date ('key')
            value: data.temperatures[i] //convert string to number (the + does)
        });
    }
